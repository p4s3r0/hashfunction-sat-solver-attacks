...
int CRYPTO_BYTES;
int BIG_STEPS_ROUNDS;
int SMALL_STEPS_ROUNDS;
//----------------------------------------------------------------------------
...
int main(int argc, char *argv[])
{
	...
	INPUT_LENGTH = 64 / 8;
	BIG_STEPS_ROUNDS = strtoll(argv[1], NULL, 10);
	if(BIG_STEPS_ROUNDS >= 4)
		SMALL_STEPS_ROUNDS = BIG_STEPS_ROUNDS - 4;
	else
		SMALL_STEPS_ROUNDS = BIG_STEPS_ROUNDS;
