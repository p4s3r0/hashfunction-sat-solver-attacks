...
static inline void PROUND(state_t* s) {
  unsigned long long round_const[12] = {0xf0, 0xe1, 0xd2, 0xc3, 0xb4, 0xa5, 0x96, 0x87, 0x78, 0x69, 0x5a, 0x4b};
  for(int r = 0; r < ASCON_HASH_ROUNDS; r++)
    ROUND(s, round_const[r]);
}
